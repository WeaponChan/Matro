...
#define ZHOULU_ML_BASE_URLString        @"https:www.matrojp.com"
#define MATROJP_BASE_URL                @"https:www.matrojp.com"
#define SERVICE_GETBASE_URL             @"https:www.matrojp.com/"
#define ZHOULU_ML_CRM_URLString         @"https:vip.matrojp.com"
#define APP_ID_ZHOU                     @"01d689a05d4841c6a29d0080502bde67"
#define APP_Secrect_ZHOU                @"cca95b6b0f9a416e8ab865b3d31b7a54"
#define CHOGNZHI_PAY_URLSTRING          @"https:pay.matrojp.com"



//#define ZHOULU_ML_BASE_URLString        @"https://bbctest.matrojp.com"
//#define MATROJP_BASE_URL                @"https://bbctest.matrojp.com"
//#define SERVICE_GETBASE_URL             @"https://bbctest.matrojp.com/"
//#define ZHOULU_ML_CRM_URLString         @"https://app-test.matrojp.com"
//#define APP_ID_ZHOU                     @"test0002"
//#define APP_Secrect_ZHOU                @"123456"
//#define CHOGNZHI_PAY_URLSTRING          @"https://pay-test.matrojp.com"



#define SERVICE_BASE_URL @"https://app.matrojp.com/P2MLinkCenter/"
//#define SERVICE_BASE_URL @"http://bbctest.matrojp.com/"http://pay.matrojp.com/PayCenter/app/v200/alipay
#define SERVICE_BASEPAY_URL @"https://pay.matrojp.com/PayCenter/"
//订单支付
#define ALIPAY_SERVICE_URL      @"https://pay.matrojp.com/PayCenter/app/v200/alipay"
#define WXPAY_SERVICE_URL       @"https://pay.matrojp.com/PayCenter/app/v200/wxpay"
#define UPPPAY_SERVICE_URL      @"https://pay.matrojp.com/PayCenter/app/v200/unionpay"
...
//#define HTTP_BASE_ZHOULU_URL            @"https://app-test.matrojp.com"
...
//验证码 接口
#define Code_URLString                  @"https://app.matrojp.com/P2MLinkCenter/common/sendsms"
//判断手机号是否注册过
...
#define VIPCARDLISTIMG_DEFAULTNAME      @"vipmoren@2"
#define VIPCARDDetailIMG_DEFAULTNAME    @"morenquanka@2"
//上传头像
...
//首页地址
//https://h5-test.matrojp.com:3000
//http://61.155.212.146:3000
//#define HomeHTML_URLString              @"https://h5-test.matrojp.com:3000"
#define HomeHTML_URLString              @"https://h5.matrojp.com"
...
//店铺链接
#define DianPuURL_URLString             @"https://h5.matrojp.com"
//#define DianPuURL_URLString              @"https://h5-test.matrojp.com:3000"
