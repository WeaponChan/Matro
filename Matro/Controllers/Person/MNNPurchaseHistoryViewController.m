...
- (void)headerRefreshAction{
    ...
    NSString *  nextlocationString = [dateformatter stringFromDate:nextDat];
    NSLog(@"当前时间为：%@ next--->%@",locationString,nextlocationString);
    _currentTimeString = nextlocationString;
    [self getCardInfoWithpageIndex:@"1" withEndTime:nextlocationString];
