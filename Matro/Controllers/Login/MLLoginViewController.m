                                          ...
                                          if (!error) {
                                              if (data && data.length > 0) {
                                                  ...
                                                  if([@"1" isEqualToString:[NSString stringWithFormat:@"%@",result[@"succ"]]]){
                                                      ...
                                                      [userDefaults setObject:sex forKey:@"sex"];
                                                      [userDefaults setObject:name forKey:@"name"];
                                                      NSString *token =userDataDic[@"accessToken"];
                                                      NSLog(@"token=====%@",token);          [userDefaults setObject:userDataDic[@"accessToken"] forKey:kUSERDEFAULT_ACCCESSTOKEN];
